            ...
            <div class="row g-5">
                ...
                <div class="wow fadeIn" data-wow-delay="0.1s">
                    <div class="about-img" style="margin-top: -60px; text-align: center;">
                        <img class="img-fluid" style="max-width: 600px; " src="img/product-2.jpg" alt="">
                    </div>
                </div>
                <div class="wow fadeIn" data-wow-delay="0.5s">
                    <div class="wrapper">
                        <div class="item"><img class="img-fluid" src="img/product-2.jpg" alt=""></div>
                        <div class="item"><img class="img-fluid" src="img/product-2.jpg" alt=""></div>
                    ...
                    <button class="btn btn-warning text-light"
                        style="border-radius: 10px; margin-top: 30px; margin-bottom: 10px;">Deskripsi</button>

                    <p>Tentang Sablon Kaos</p>
                    <b class="mb-4">Stet no et lorem dolor et diam, amet duo ut dolore vero eos. No stet est diam
                    ...
                    <button class="btn btn-warning text-light" style="float: right; border-radius: 10px;">Tambah Ke
                        Keranjang</button>
                </div>
            </div>
        </div>
