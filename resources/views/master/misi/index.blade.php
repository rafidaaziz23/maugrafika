    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Table Misi
            </div>
            <div class="card-toolbar">
                ...
                <!--end::Dropdown-->
                <!--begin::Button-->
                <a href="{{ route('misi.create') }}" class="btn btn-light-success btn-sm font-weight-bolder">
        ...
        <div class="card-body">
            ...
            <table class="table">
                <thead class="thead-dark">
                    ...
                    <th style="text-align:center;">Nomor Misi</th>
                    <th style="text-align:center;">Detail Misi</th>
                ...
                <tbody>
                    @foreach ($misi as $key => $value)
                        <tr>
                            ...
                            <td>{{ $value->misi_number }}</td>
                            <td>{{ $value->misi_detail }}</td>
                            <td>
                                <form action="{{ route('misi.destroy', $value->id) }}" method="POST">

                                    <a href="{{ route('misi.edit', $value->id) }}" class="btn btn-sm btn-warning"
                                        title="Edit">
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-sm btn-danger kt-font-bold kt-font-danger"
                                        title="Hapus">
