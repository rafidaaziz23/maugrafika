        ...
        <form action="{{ route('misi.update',$misi->id) }}" method="POST">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-6">
                        <input type="text" name="misi_number" id="misi_number" class="form-control" value="{{ $misi->misi_number }}" placeholder="Masukkan Number" autocomplete="off" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-6">
                        <input type="text" name="misi_detail" id="misi_detail" class="form-control" value="{{ $misi->misi_detail }}" placeholder="Masukkan Detail" autocomplete="off" />
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-3">
                        <span class="switch switch-success">
                            <label>
                                <input type="checkbox" checked="checked" name="kategori_jasa_is_active" value="{{ $misi->kategori_jasa_is_active }}" />
                                <span></span>
                            </label>
                        </span>
                    </div>
