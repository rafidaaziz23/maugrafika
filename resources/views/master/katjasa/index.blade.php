...
<div class="card card-custom">
   <div class="card-header flex-wrap border-0 pt-6 pb-0">
      <div class="card-title">
         <h3 class="card-label">Table Kategori Jasa
      </div>
      <div class="card-toolbar">
         ...
         <!--end::Dropdown-->
         <!--begin::Button-->
         <a href="{{ route('kategori-jasa.create') }}" class="btn btn-light-success btn-sm font-weight-bolder">
   ...
   <div class="card-body">
      ...
      <table class="table">
         ...
         <tbody>
            @foreach($kategoriJasa as $key => $value)
            <tr>
               <td>
                  {{ ++$i }}
               </td>
               <td>{{ $value->kategori_jasa_nama }}</td>
               <td>
                  <form action="{{ route('kategori-jasa.destroy',$value->id) }}" method="POST">

                     <a href="{{ route('kategori-jasa.edit',$value->id) }}" class="btn btn-sm btn-warning" title="Edit">
