...
<div class="card">
   <div class="card card-custom">
      ...
      <form action="{{ route('kategori-jasa.store') }}" method="POST">
         @csrf
         <div class="card-body">
            <div class="form-group row">
               <label class="col-3 col-form-label">Nama Kategori Jasa
                  <span class="text-danger">*</span>
               </label>
               <div class="col-6">
                  <input type="text" name="kategori_jasa_nama" id="kategori_jasa_nama" class="form-control" placeholder="Masukkan Kategori" autocomplete="off" />
               </div>
            </div>
            <div class="form-group row">
