...
<div class="card">
   <div class="card card-custom">
      ...
      <form action="{{ route('kategori-jasa.update',$kategoriJasa->id) }}" method="POST">
         @csrf
         @method('PUT')
         <div class="card-body">
            <div class="form-group row">
               ...
               <div class="col-6">
                  <input type="text" name="kategori_jasa_nama" id="kategori_jasa_nama" class="form-control" value="{{ $kategoriJasa->kategori_jasa_nama }}" placeholder="Masukkan Kategori" autocomplete="off"/>
               </div>
            </div>
            <div class="form-group row">
               ...
               <div class="col-3">
                  <span class="switch switch-success">
                     <label>
                        <input type="checkbox" checked="checked" name="kategori_jasa_is_active" value="{{ $kategoriJasa->kategori_jasa_is_active }}" />
                        <span></span>
                     </label>
                  </span>
               </div>
