   ...
   <div class="card card-custom">
      <div class="card-header flex-wrap border-0 pt-6 pb-0">
         <div class="card-title">
            <h3 class="card-label">Form kategori Produk
         </div>
      ...
      <form action="{{ route('kategori-produk.store') }}" method="POST">
         ...
         <div class="card-body">
            <div class="form-group row">
               <label class="col-3 col-form-label">Nama Kategori Produk
                  <span class="text-danger">*</span>
               </label>
               <div class="col-6">
                  <input type="text" name="kategori_produk_nama" id="kategori_produk_nama" class="form-control" placeholder="Masukkan Kategori" autocomplete="off" />
               </div>
            </div>
            <div class="form-group row">
               ...
               <div class="col-3">
                  <span class="switch switch-success">
                     <label>
                        <input type="checkbox" checked="checked" name="kategori_produk_is_active" />
                        <span></span>
                     </label>
                  </span>
               </div>
