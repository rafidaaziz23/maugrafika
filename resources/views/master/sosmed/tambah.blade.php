      ...
      <form action="{{ route('sosmed.store') }}" method="POST" enctype="multipart/form-data">
         ...
         <div class="card-body">
            <div class="form-group row">
               ...
               <div class="col-6">
                  <input type="text" name="sosmed_nama" id="sosmed_nama" class="form-control" placeholder="Masukkan Sosmed" autocomplete="off" />
               </div>
            </div>
            <div class="form-group row">
               ...
               <div class="col-6">
                  <input type="text" name="sosmed_link" id="sosmed_link" class="form-control" placeholder="Masukkan Link" autocomplete="off" />
               </div>
            </div>
            <div class="form-group row">
