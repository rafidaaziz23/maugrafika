    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Form Tambah Visi
            </div>
        ...
        <form action="{{ route('visi.store') }}" method="POST">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-6">
                        <input type="text" name="visi_number" id="visi_number" class="form-control" placeholder="Masukkan Kategori" autocomplete="off" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-6">
                        <input type="text" name="visi_detail" id="visi_detail" class="form-control" placeholder="Masukkan Kategori" autocomplete="off" />
                    </div>
                </div>
                <div class="form-group row">
