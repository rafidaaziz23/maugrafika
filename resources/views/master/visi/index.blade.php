...
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label">Table Visi
        </div>
        <div class="card-toolbar">
            ...
            <!--end::Dropdown-->
            <!--begin::Button-->
            <a href="{{ route('visi.create') }}" class="btn btn-light-success btn-sm font-weight-bolder">
    ...
    <div class="card-body">
        ...
        <table class="table">
            <thead class="thead-dark">
                ...
                <th style="text-align:center;">Nomor Visi</th>
                <th style="text-align:center;">Detail Visi</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $value->visi_number }}</td>
                    <td>{{ $value->visi_detail }}</td>
                    <td>
                        <form action="{{ route('visi.destroy',$value->id) }}" method="POST">

                            <a href="{{ route('visi.edit',$value->id) }}" class="btn btn-sm btn-warning" title="Edit">
