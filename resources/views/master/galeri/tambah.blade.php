    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Form Tambah Galeri
            </div>
        ...
        <form action="{{ route('galeri.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-6">
                        <input type="text" name="galeri_nama" id="galeri_nama" class="form-control" placeholder="Masukkan Kategori" autocomplete="off" />
                    </div>
                </div>
                    ...
                    <div class="col-9">
                        <div class="image-input image-input-empty image-input-outline" id="kt_image_5">
                            ...
                            <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
                                ...
                                <input type="file" name="galeri_image" accept=".png, .jpg, .jpeg" />
