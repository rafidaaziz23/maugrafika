    ...
    <div class="card-body">
        ...
        <div class="mb-11">
            ...
            <div class="d-flex justify-content-between align-items-center mb-7">
                ...
                <a href="{{ route('galeri.create') }}" class="btn btn-light-success btn-sm font-weight-bolder">Tambah</a>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="overlay">
                                <div class="overlay-wrapper rounded bg-light text-center">
                                    <img style="width: 100px; height:100px;" src="{{ Storage::url('public/uploads/galeri/').$value->galeri_image }}" alt="{{ $value->galeri_image}}">
                                </div>
                                <div class="overlay-layer">
                                    <a href="#" class="btn font-weight-bolder btn-sm btn-primary mr-1">Quick View</a>
                                    <a href="{{route('galeri.edit',$value->id)}}" class="btn font-weight-bolder btn-sm btn-warning mr-1">Edit Photo</a>
