      ...
      <form action="{{ route('karir.update',$karir->id) }}" method="POST">
         ...
         <div class="card-body">
            <div class="form-group row">
               ...
               <div class="col-9">
                  <input type="text" name="karir_position" id="karir_position" class="form-control" value="{{ $karir['karir_position'] }}" placeholder="Masukkan Nama" autocomplete="off" />
               </div>
            </div>
            <div class="form-group row">
               ...
               <div class="col-9">
                  <textarea name="karir_detail" id="karir_detail" class="form-control" rows="3">{{ $karir['karir_detail'] }}</textarea>
               </div>
            </div>
            <div class="form-group row">
               <label class="col-3 col-form-label">Detail Pekerjaan
               ...
               <div class="col-9">
                  <select class="form-control selectpicker" title="-- Pilih --" name="karir_type">
                     <option value="Intern" class="{{ ($karir['karir_type'] == 'Intern')?'selected-active':'' }}">Intern</option>
                     <option value="Full-time" class="{{ ($karir['karir_type'] == 'Full-time')?'selected-active':'' }}">Full-time</option>
                  </select>
               </div>
            </div>
            <div id="reqruitment">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-9">
                     ...
                     <div class="input-group mb-1">
                        <input type="text" class="form-control" name="reqruitment_detail[{{ $key }}]" placeholder="Masukkan Syarat" autocomplete="off" value="{{ $value['reqruitment_detail'] }}"/>
                     </div>
                     @endforeach
            ...
            <div id="task">
               <div class="form-group row">
                  ...
                  <div class="col-9">
                     ...
                     <div class="input-group mb-1">
                        <input type="text" class="form-control" name="task_detail[{{ $key }}]" placeholder="Masukkan Tugas" autocomplete="off" value="{{ $value['task_detail'] }}"/>
                     </div>
                     @endforeach
