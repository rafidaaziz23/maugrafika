    ...
    <div class="card-body">
        ...
        <table class="table">
            <thead class="thead-dark">
                ...
                <th style="text-align:center;">Nama Faq</th>
                <th style="text-align:center;">Detail Faq</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $value->faq_detail }}</td>
                    <td>
                        <form action="{{ route('faq.destroy',$value->id) }}" method="POST">

                            <a href="{{ route('faq.edit',$value->id) }}" class="btn btn-sm btn-warning" title="Edit">
