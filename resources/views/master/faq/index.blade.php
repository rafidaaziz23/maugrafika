...
<div class="card card-custom">
   <div class="card-header flex-wrap border-0 pt-6 pb-0">
      ...
      <div class="card-toolbar">
         ...
         <!--end::Dropdown-->
         <!--begin::Button-->
         <a href="{{ route('faq.create') }}" class="btn btn-light-success btn-sm font-weight-bolder">
   ...
   <div class="card-body">
      ...
      <div class="accordion accordion-toggle-arrow" id="faq_parent">
        @php
            $i = 0;
        @endphp  
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title" data-toggle="collapse" data-target="#faq_detail[{{ $i }}]">
                    {{ $value['faq_title'] }}
                </div>
            </div>
            <div id="faq_detail[{{ $i }}]" class="collapse show" data-parent="#faq_parent">
                <div class="card-body">
                    {{ $value['faq_detail'] }}
                </div>
            </div>
