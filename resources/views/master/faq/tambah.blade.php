      ...
      <form action="{{ route('faq.store') }}" method="POST">
         ...
         <div class="card-body">
            <div class="form-group row">
               ...
               <div class="col-6">
                  <input type="text" name="faq_title" id="faq_title" class="form-control" placeholder="Masukkan Faq" autocomplete="off" />
               </div>
            </div>
            <div class="form-group row">
               ...
               <div class="col-6">
                  <input type="text" name="faq_detail" id="faq_detail" class="form-control" placeholder="Masukkan Detail" autocomplete="off" />
               </div>
            </div>
            <div class="form-group row">
